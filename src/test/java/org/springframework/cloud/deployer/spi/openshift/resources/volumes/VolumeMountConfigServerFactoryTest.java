...
public class VolumeMountConfigServerFactoryTest {
	...
	@Before
	public void setup() {
		configServicePropertySourceLocator = new ConfigServicePropertySourceLocator(
				null) {

			@Override
			public PropertySource<?> locate(Environment environment) {
				return new MockPropertySource()
						.withProperty("volumeMounts[0].name", "testVolume")
	...
	public void addVolumeMounts() {
		volumeMountFactory = new VolumeMountConfigServerFactory(
				configServicePropertySourceLocator, new OpenShiftDeployerProperties());
	...
	public void addVolumeMountsWithNoConfig() {
		volumeMountFactory = new VolumeMountConfigServerFactory(
				new ConfigServicePropertySourceLocator(null) {
